...
function Cards() {
    ...
    const trendList = [{
        name:'BMW',
        src:'https://images.unsplash.com/photo-1567808291548-fc3ee04dbcf0?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        specification:'BMW 3 series',
        speed:'420 KMPH',
        Average:"8 KMPL"
    }
    ,
    ...
    {
        name:'Ducati',
        src:'https://images.unsplash.com/photo-1623756005234-9cfaafc647dd?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        specification:'Ducati 1299',
        speed:'320 KMPH',
        Average:"10 KMPL"
    },
    {
        name:'Bullet',
        src:'https://images.unsplash.com/photo-1614152412509-7a5afc18c75b?q=80&w=1854&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        specification:'Bullet 250CC',
        speed:'250 KMPH',
        Average:"20 KMPL"
    },
    {
        name:'KTM',
        src:'https://images.unsplash.com/photo-1591637333184-19aa84b3e01f?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        specification:'KTM 790',
        speed:'290 KMPH',
        Average:"14 KMPL"
    },
    {
        name:'Ducati',
        src:'https://images.unsplash.com/photo-1608461688075-127d0f2deba2?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        specification:'Scrambler',
        speed:'300 KMPH',
        Average:"12.5 KMPL"
    },
    {
        name:'Triump',
        src:'https://images.unsplash.com/photo-1623081259457-508f409f71cc?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        specification:'Triump 680',
        speed:'270KMPH',
        Average:"13 KMPL"
    },
    {
...
// trendList.map((item)=>console.log(item.src))
  ...
  return (
    <div>
      ...
      <h1 style={{margin:'0 0 0 6vw'}} className="heading-text">Trending</h1></div>
...
return <div className="cardReview">
  <div className="content">
    <div className="back">
      <div className="back-content">
       ...
       <img key={index}  style={{width:"100%"}} src={item.src}/>
      </div>
    </div>
    <div className="front">
      ...
      <div className="front-content">
        ...
        <div className="description">
          ...
          <p className="card-footer">
            Speed:{item.speed} &nbsp; | &nbsp;  Average:{item.Average}
          </p>
        </div>
      </div>
